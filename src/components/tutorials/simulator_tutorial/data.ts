...
export const tutorialSteps: TutorialStep[] = [
  ...
  },
  {
    ...
    description: `The simulation grid is large and designed for flexible network layouts. To pan around the grid:`,
    bullets: [
      `${Emoji.HandRaised} <i>On Desktop</i>, <b>hold the right mouse button and drag.</b>`,
      `${Emoji.KeyCapThree} <i>On Touch Devices</i>, <b>swipe with 3 fingers.</b>`,
    ],
    videoSrc: videoSrc("panning_1.mp4"),
    footer: "This allows you to easily navigate large or complex topologies.",
  },
  {
    title: "Navigating the Grid - Zooming In",
    description: `The simulation grid is large and designed for flexible network layouts. To zoom in on the grid:`,
    bullets: [
      `If you have a mouse, ${italicBoldString("scroll up to zoom in")}`,
      `If you have a touchpad, ${italicBoldString("pinch outward to zoom in")}`,
      `On mobiles / tablets, ${italicBoldString("pinch outward to zoom in")}`,
    ],
  ...
  },
  {
    ...
    description: `The simulation grid is large and designed for flexible network layouts. To zoom out on the grid:`,
    bullets: [
      `If you have a mouse, ${italicBoldString("scroll down to zoom out")}`,
      `If you have a touchpad, ${italicBoldString("pinch inward to zoom out")}`,
      `On mobiles / tablets, ${italicBoldString("pinch inward to zoom out")}`,
    ],
